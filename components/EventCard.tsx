...
export function EventCard({ eventId }: { eventId: Id<"events"> }) {
  ...
  const renderTicketStatus = () => {
   ...
   return ( 
     ...
     border-gray-100 cursor-pointer overflow-hidden relative
         ...
         <div className="flex justify-between items-start">
           ...
           <div>
             <div className="flex flex-col items-start gap-2">
               {isEventOwner && (
                 <span className="inline-flex items-center gap-1 bg-blue-600/90 text-px-2 py-1 rounded-full text-xs font-medium">
                   <StarIcon className="-3 h-3" />
                   Your Event
                 </span>
               )}
